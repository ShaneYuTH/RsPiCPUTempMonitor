...
# April 10, 2021
# This module is used to make a tweet on behalf of an authorized Twitter account.
# Thanks to 2017.compciv.org/guide/topics/python-nonstandard-libraries/twython-guide/twitter-twython-app-auth.html for walkthrough on authentication
